...
> Each issue **must** be reproducible with either a failing test, sample code, gist, link to a stand-alone project or clear steps to reproduce the issue including all configuration/environment settings as needed
